...
[Files]
; Archivos de la aplicación (todos los archivos de la carpeta installer excepto appsettings.json)
Source: "installer\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "appsettings.json"
