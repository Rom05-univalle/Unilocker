...
async function loadDashboardStats() {
  try {
    ...
    document.getElementById('incidentsBreakdown').innerText = `${pending} Pendientes, ${inReview} En Revisión`;
...
async function loadSessionsChart() {
  try {
    ...
    console.error('Error cargando sesiones por d�a', err);
  }
}

// ----------------- Gr�fico: Reportes por tipo -----------------
...
async function exportToCSV() {
  try {
    ...
    csv += 'Top 5 equipos con m�s reportes\n';
    csv += 'Equipo,Reportes\n';
    ...
    csv += 'Top 5 usuarios m�s activos\n';
